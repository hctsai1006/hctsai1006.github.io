...
export const WORK = [
  // ------------------------------------------------------------------ Ground truth
  {
    ...
    tasks: [
      ...
      { id: '1.3', title: 'Script a headless capture of every command in CMDLETS + ALIAS + EGGS against v1', detail: '67 cmdlets, 46 aliases, 11 easter eggs — enumerated in the architecture survey.', status: 'todo' },
      { id: '1.4', title: 'Store transcripts as tests/conformance/fixtures/v1/*.txt keyed by command', status: 'todo' },
      { id: '1.5', title: 'Record the 4 seeded history entries and the boot banner as fixtures too', status: 'todo' },
    ],
    acceptance: [
